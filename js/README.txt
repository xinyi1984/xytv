...
"thread_limit":10, //這裏是阿里云盤的GO代理的并發協程數或java代理的并發綫程數，并非越大越好，最高到64足以, 若遇到賬號被限制并發數，請將此數值改爲10
"quark_thread_limit":10, //這裏是夸克網盤GO代理的并發協程數或java代理的并發綫程數，并非越大越好，最高到64足以, 若遇到賬號被限制並發數，請將此數值改爲10
